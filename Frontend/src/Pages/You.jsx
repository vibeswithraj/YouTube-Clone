...
const You = () => {
  const { allData, asideOpen, theme } = useContext(detailContext);
  ...
  return (
    ...
    >
      ...
      <div
        className={
          asideOpen
            ? "w-full px-20 h-screen bg-[#0F0F0F] text-white py-7 justify-center overflow-y-scroll no-scrollbar"
            : "w-full px-20 h-screen bg-[#0F0F0F] text-white py-7 justify-center overflow-y-scroll no-scrollbar"
        }
      >
        ...
        <div className="w-auto h-auto flex flex-col mt-7 gap-3">
          <Slider name={"History "} allData={allData} path={"/feed/history"}/>
          <Slider name={"Playlists "} allData={allData} path={"/feed/playlists"}/>
          <Slider name={"Watch later "} allData={allData} path={"/feed/watchlater"}/>
          <Slider name={"Liked videos "} allData={allData} path={"/feed/likedvideos"}/>
        </div>
      </div>
    </div>
  );
